...
data EditMessageTextRequest = EditMessageTextRequest
  ...
  , editMessageTextInlineMessageId       :: Maybe Text -- ^ Required if 'editMessageTextChatId' and 'editMessageTextMessageId' are not specified. Identifier of the sent message.
